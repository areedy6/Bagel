...
-- ("When you stand out of bed you are so fatigued from hunger that your legs give out and you hit your head on the corner of a table. You will not be getting a bagel today. ", 35,35),
...
-- ("You’ve forgotten you live in Spain, today is the running of the bulls. Run for your life! You will not be getting your bagel today ", 35,35),
...
-- ("Your car has been infested by mild mannered raccoons! You will not be getting your bagel today", 35,35),
...
-- ("So it looks like you’re not getting a bagel today? I’m sorry but I don’t think you've read the directions. Please start over", 35,35),
...
-- ("While waiting at the crosswalk you fail to notice the piano being delivered via crane. You are squished by a piano, Wile E Coyote style. You will not be getting a bagel today", 35,35),
-- ("The heat is on, what has started out as a chill morning has now resulted in you being arrested. There are zero bagels in this prison.", 35,35),
...
-- ("This weird boy is so thankful you helped him find his Fairy God Parents, Comso and Wanda, he asks you to make a wish and he’ll make it come true. A. This kid is VERY weird and you do NOT think this is real. You continue on your way in a very expedited manor @ B. You wish for an infinite bagels", 27,28),
...
-- ("There still aren’t any bagels at your house. You will not receive a bagel today.", 35,35),
-- ("This was definitely not one of those “cool cops”. He has given you a $500 ticket for J walking, cleaning out your bank account. There is no way for you to get a bagel today", 35,35),
...
-- ("All your patience today has paid off. Your wildest dream has finally come true… Congratulations you have received your bagel!", 36,36),
-- ("This turns out to be a rouge troupe of girl scouts. They jump you and take all of your possessions. You are penniless and will not be getting a bagel today", 35,35),
-- ("Timmy is offended by this and wishes for you to never have a bagel again. You will not be getting a bagel today or ever again", 35,35),
-- ("The sky opens and an endless downpour of everything bagels covers the land. You are suffocated by your own greed and desires. You have succeeded in getting your bagel today, but at what cost? You expire under a mountain of everything bagels ", 35,35),
-- ("The zen flows through you. All those yoga classes have been really paying off. Your dog is calm too and you hit a sick tree pose, giving you full mental clarity. You B-line to the bagel shop. You get your bagel today", 36,36),
...
-- ("Bagels literally don’t exist in Mexico. You will not be getting a bagel today", 35,35),
...
-- ("You have been taken away to Federal Prison. Society takes j walking VERY serious. Luckily they’re still serving breakfast, bagels infact. Congratulations you have received your bagel.", 36,36),
-- ("You are a bagel-less coward", 35,35);
-- (35,"", 1,1);
-- (36,"", 1,1);